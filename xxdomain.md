...
<img src="https://github.com/BeAShaper/Hello-World/blob/master/1.png" width=60%>

#### 截图2
在输入框输入源语言的待翻译文字，输入框下方会实时生成目标语言的翻译结果。
<img src="https://github.com/BeAShaper/Hello-World/blob/master/2.png" width=60%>
...
<img src="https://github.com/BeAShaper/Hello-World/blob/master/5.png" width=60%>

#### 截图6
点击笔的按钮，可以手写方式输入 93 种语言的字符进行翻译。
<img src="https://github.com/BeAShaper/Hello-World/blob/master/6.png" width=60%>
